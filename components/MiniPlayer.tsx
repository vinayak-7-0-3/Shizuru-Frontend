...
const MiniPlayer = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-lg border-t border-black/10 dark:border-white/10 p-4 z-50">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={togglePlay}
            className="p-3 rounded-full bg-black dark:bg-white text-white dark:text-black hover:scale-105 transition-transform"
        ...
        <div className="flex items-center gap-2 flex-1 max-w-xs">
          <span className="text-xs text-black/70 dark:text-white/70 min-w-[35px]">
          ...
          <div className="flex-1">
            <input
              ...
              value={progress}
              onChange={handleSeek}
              className="w-full h-1 bg-black/20 dark:bg-white/20 rounded-lg appearance-none cursor-pointer progress-slider"
